...
// load disciplinary committee details from web server
// and display those within this screen
// from other class, data is passed to this screen via constructor call

class DisciplinaryCommitteeScreen extends StatefulWidget {
  final int subSectionId;
  final String name;
  final String type;
  final String image;

  const DisciplinaryCommitteeScreen({
    super.key,
  ...
  @override
  State<DisciplinaryCommitteeScreen> createState() =>
      _DisciplinaryCommitteeScreenState();
}

class _DisciplinaryCommitteeScreenState
    extends State<DisciplinaryCommitteeScreen> {
  bool isLoading = true;
  String? errorMessage;
  ...
  // This method displays the list of HSI Committee
  ...
  Widget _buildDisciplinaryHeading(DisciplinHeadingDetail heading) {
    return Padding(
      padding: EdgeInsets.only(bottom: 16.h, left: 16.w, right: 16.w),
      child: Column(
        crossAxisAlignment: CrossAxisAlignment.start,
        children: [
          Text(heading.heading, style: subtitleofAboutHsiTextStyle),
          if (heading.documents.isNotEmpty) ...[
            SizedBox(height: 8.h),
            ListView.separated(
