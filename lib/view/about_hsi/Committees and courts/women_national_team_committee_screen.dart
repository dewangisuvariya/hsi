...
// load Women's National Team Committee details from web server
// and display those within this screen
// from other class, data is passed to this screen via constructor call

class WomenNationalTeamCommitteeScreen extends StatefulWidget {
  final int subSectionId;
  final String name;
  final String type;
  final String image;

  const WomenNationalTeamCommitteeScreen({
    super.key,
  ...
  @override
  State<WomenNationalTeamCommitteeScreen> createState() =>
      _WomenNationalTeamCommitteeScreenState();
}

class _WomenNationalTeamCommitteeScreenState
    extends State<WomenNationalTeamCommitteeScreen> {
  bool isLoading = true;
  String? errorMessage;
  ...
  // When the user taps the button, the selected file (PDF, Word, or Excel) should launch in the appropriate viewe
  ...
  // This method displays the list of Women's National Team Committee member
