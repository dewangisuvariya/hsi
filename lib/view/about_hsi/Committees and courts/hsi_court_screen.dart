...
// load court details from web server
// and display those within this screen
// from other class, data is passed to this screen via constructor cal
class HsiCourtScreen extends StatefulWidget {
  final int subSectionId;
  final String name;
  final String type;
  final String image;
  const HsiCourtScreen({
    super.key,
  ...
  @override
  State<HsiCourtScreen> createState() => _HsiCourtScreenState();
}

class _HsiCourtScreenState extends State<HsiCourtScreen> {
  bool isLoading = true;
  String? errorMessage;
