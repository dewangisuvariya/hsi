...
// load Law Commission details from web server
// and display those within this screen
// from other class, data is passed to this screen via constructor call
class LawCommissionScreen extends StatefulWidget {
  final int subSectionId;
  final String name;
  final String type;
  final String image;

  const LawCommissionScreen({
    super.key,
  ...
  @override
  State<LawCommissionScreen> createState() => _LawCommissionScreenState();
}

class _LawCommissionScreenState extends State<LawCommissionScreen> {
  bool isLoading = true;
  String? errorMessage;
  ...
  // This method displays the list of Legal Committee Member
