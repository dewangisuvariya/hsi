...
class HsiCourtOfAppealScreen extends StatefulWidget {
  final int subSectionId;
  final String name;
  final String type;
  final String image;
  const HsiCourtOfAppealScreen({
    super.key,
  ...
  @override
  State<HsiCourtOfAppealScreen> createState() => _HsiCourtOfAppealScreenState();
}

class _HsiCourtOfAppealScreenState extends State<HsiCourtOfAppealScreen> {
  bool isLoading = true;
  String? errorMessage;
