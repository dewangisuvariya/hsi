...
// load Handball Referees Association of Iceland details from web server
// and display those within this screen
// from other class, data is passed to this screen via constructor call

class HandballRefereesAssociationOfIcelandScreen extends StatefulWidget {
  final int subSectionId;
  final String name;
  final String type;
  final String image;

  const HandballRefereesAssociationOfIcelandScreen({
    super.key,
  ...
  @override
  State<HandballRefereesAssociationOfIcelandScreen> createState() =>
      _HandballRefereesAssociationOfIcelandScreenState();
}

class _HandballRefereesAssociationOfIcelandScreenState
    extends State<HandballRefereesAssociationOfIcelandScreen> {
  bool isLoading = true;
  String? errorMessage;
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          ...
          inspector = response.data.inspectorDetails;
  ...
  // This metthod displays the list of HSI HDSÍ board consists
            ...
            child: Column(
              ...
              children: [
                ...
                if (member.details != null && member.details!.isNotEmpty)
                  Text(member.details!, style: subtitleOfCoachOrTeamTextStyle),
              ],
            ),
          ),
        ],
  ...
  // This method displays the list of HSI Inspector
  Widget _buildInspector(Inspector member) {
    return Padding(
      padding: EdgeInsets.only(bottom: 10.h),
      child: Row(
        children: [
          ...
          Expanded(
            child: Column(
              ...
              children: [
                Text(member.name, style: titleOfCoachOrTeamTextStyle),
                // if (member. != null && member.details!.isNotEmpty)
                              ...
                              Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    ...inspector.map(_buildInspector).toList(),
                                  ],
                                ),
                              ),
                            ...committeeHeadingDetail.map(
