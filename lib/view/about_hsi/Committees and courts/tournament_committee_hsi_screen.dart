...
// load Tournament Committee details from web server
// and display those within this screen
// from other class, data is passed to this screen via constructor call
class TournamentCommitteeHsiScreen extends StatefulWidget {
  final int subSectionId;
  final String name;
  final String type;
  final String image;

  const TournamentCommitteeHsiScreen({
    super.key,
  ...
  @override
  State<TournamentCommitteeHsiScreen> createState() =>
      _TournamentCommitteeHsiScreenState();
}

class _TournamentCommitteeHsiScreenState
    extends State<TournamentCommitteeHsiScreen> {
  bool isLoading = true;
  String? errorMessage;
  ...
  // This method displays the list of tournament committee member
