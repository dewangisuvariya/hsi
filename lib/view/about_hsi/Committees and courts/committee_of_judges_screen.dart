...
// load committee details from web server
// and display those within this screen
// from other class, data is passed to this screen via constructor call
class CommitteeOfJudgesScreen extends StatefulWidget {
  final int subSectionId;
  final String name;
  final String type;
  final String image;

  const CommitteeOfJudgesScreen({
    super.key,
  ...
  @override
  State<CommitteeOfJudgesScreen> createState() =>
      _CommitteeOfJudgesScreenState();
}

class _CommitteeOfJudgesScreenState extends State<CommitteeOfJudgesScreen> {
  bool isLoading = true;
  String? errorMessage;
  ...
  // This method displays the list of HSI judges
