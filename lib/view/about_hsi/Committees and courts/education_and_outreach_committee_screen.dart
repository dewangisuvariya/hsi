...
// load Education and Outreach Committee details from web server
// and display those within this screen
// from other class, data is passed to this screen via constructor call
class EducationAndOutreachCommitteeScreen extends StatefulWidget {
  final int subSectionId;
  final String name;
  final String type;
  final String image;

  const EducationAndOutreachCommitteeScreen({
    super.key,
  ...
  @override
  State<EducationAndOutreachCommitteeScreen> createState() =>
      _EducationAndOutreachCommitteeScreenState();
}

class _EducationAndOutreachCommitteeScreenState
    extends State<EducationAndOutreachCommitteeScreen> {
  bool isLoading = true;
  String? errorMessage;
  ...
  // This method displays the list of HSI Education and Outreach Committee
