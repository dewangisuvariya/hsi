...
// load Achievement policy  details from web server
// and display those within this screen
// from other class, data is passed to this screen via constructor call
class AchievementPolicyOfHsiScreen extends StatefulWidget {
  final int subSectionId;
  final String name;
  final String type;
  final String image;
  const AchievementPolicyOfHsiScreen({
    super.key,
  ...
  @override
  State<AchievementPolicyOfHsiScreen> createState() =>
      _AchievementPolicyOfHsiScreenState();
}

class _AchievementPolicyOfHsiScreenState
    extends State<AchievementPolicyOfHsiScreen> {
  bool isLoading = true;

  HeadingDetails? _heading;
  String? errorMessage;
  List<AchievementPolicyDetail> achievementPolicyDetail = [];
    ...
    try {
      ...
      if (mounted) {
        setState(() {
          ...
          achievementPolicyDetail = response.data.achievementPolicyDetails;
          isLoading = false;
        });
      }
    } catch (e) {
                              ...
                              child: Padding(
                                ...
                                child: Column(
                                  ...
                                  children: [
                                    ...
                                    ...achievementPolicyDetail.map((pdfDetail) {
                                      return ElevatedButton(
                                        onPressed: () {
                                          _launchPdf(
                                            pdfDetail.achievementDetail,
                                          );
                                        },
