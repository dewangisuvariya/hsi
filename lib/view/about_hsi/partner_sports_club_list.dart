...
class _AoildarfelogHsi extends State<AoildarfelogHsi> {
        ...
        children: [
          Column(
            children: [
              ...
              Expanded(
                child: _leagueList(screenHeight, screenWidth, isWideScreen),
              ),
            ],
          ),
          if (isLoading)
  ...
  Widget _leagueTile(
    ...
    if (isWideScreen) {
      return customTabGridView(club, isSelected, index);
    } else {
      return customMobileGridView(club, isSelected, index, screenHeight);
    }
  }
  ...
  InkWell customTabGridView(Club club, bool isSelected, int index) {
    return InkWell(
      onTap: () {
        Navigator.of(context).push(
          MaterialPageRoute(
