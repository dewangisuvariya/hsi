...
// load annual meeting details from web server
// and display those within this screen
// from other class, data is passed to this screen via constructor call
class HsiAnnualMeetingScreen extends StatefulWidget {
  final int subSectionId;
  final String name;
  final String type;
  final String image;

  const HsiAnnualMeetingScreen({
    super.key,
  ...
  @override
  State<HsiAnnualMeetingScreen> createState() => _HsiAnnualMeetingScreenState();
}

class _HsiAnnualMeetingScreenState extends State<HsiAnnualMeetingScreen> {
  bool isLoading = true;
  String? errorMessage;
