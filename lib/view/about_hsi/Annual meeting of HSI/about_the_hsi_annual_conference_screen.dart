...
// load about the hsi annual conference  details from web server
// and display those within this screen
// from other class, data is passed to this screen via constructor call
class AboutTheHsiAnnualConferenceScreen extends StatefulWidget {
  final int subSectionId;
  final String name;
  final String type;
  final String image;

  const AboutTheHsiAnnualConferenceScreen({
    super.key,
  ...
  @override
  State<AboutTheHsiAnnualConferenceScreen> createState() =>
      _AboutTheHsiAnnualConferenceScreenState();
}

class _AboutTheHsiAnnualConferenceScreenState
    extends State<AboutTheHsiAnnualConferenceScreen> {
  bool isLoading = true;
  String? errorMessage;
