...
class ManWomenLeaguesDetailScreen extends StatefulWidget {
  const ManWomenLeaguesDetailScreen({super.key});

  @override
  State<ManWomenLeaguesDetailScreen> createState() =>
      _ManWomenLeaguesDetailScreenState();
}

class _ManWomenLeaguesDetailScreenState
    extends State<ManWomenLeaguesDetailScreen>
