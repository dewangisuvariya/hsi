...
class _StrengthTrainingUSeventeenAndUNineteenVideoListScreenState
                      ...
                      child: Container(
                        ...
                        child: ListTile(
                          title: Text(
                            ...
                            style:
                                isLargeScreen
                                    ? videoListTitleTextStyle.copyWith(
                                      fontSize: 20.sp,
                                    )
                                    : videoListTitleTextStyle,
                          ),
                          trailing: GestureDetector(
                            onTap: () => _toggleSectionExpansion(level.id),
                            child: SizedBox(
                              height: isLargeScreen ? 25.h : 20.h,
    ...
    return Padding(
      ...
      child: Align(
        ...
        child: Text(
          ...
          style:
              isLargeScreen
                  ? emailOtpScreenTextStyle.copyWith(
  ...
  Widget _buildVideoList(List<VideoItem> videos, bool isLargeScreen) {
    if (videos.isEmpty) {
      return const SizedBox();
    }
              ...
              child: Row(
                children: [
                  Padding(
                    ...
                    child: Image.asset(
                      videoPlay,
                      width: isLargeScreen ? 44.w : 34.w,
                      height: isLargeScreen ? 44.h : 34.h,
                      fit: BoxFit.contain,
                    ...
                    child: Column(
                      ...
                      children: [
                        ...
                        Text(
                          ...
                          style:
                              isLargeScreen
                                  ? videoSubtitleTextStyle.copyWith(
                                    fontSize: 16.sp,
                                  )
                  ...
                  Padding(
                    ...
                    child: CircleAvatar(
                      ...
                      radius: isLargeScreen ? 20.r : 17.r,
                      child: Center(
                        child: Image.asset(
                          isSelected
