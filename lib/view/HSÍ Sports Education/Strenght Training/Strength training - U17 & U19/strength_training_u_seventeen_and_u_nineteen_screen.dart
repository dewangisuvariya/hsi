...
import 'package:hsi/view/HS%C3%8D%20Sports%20Education/Strenght%20Training/Strength%20training%20-%20U17%20&%20U19/strength_training_U_seventeen_and_U_nineteen_video_list_screen.dart';
import 'package:provider/provider.dart';

// load strenght training USeventeen and UNineteen details from web server
// and display those within this screen
// from other class, data is passed to this screen via constructor call
class StrengthTrainingUSeventeenAndUNineteenScreen extends StatefulWidget {
  final int id;
  ...
  const StrengthTrainingUSeventeenAndUNineteenScreen({
    super.key,
    required this.id,
    required this.name,
    required this.image,
  ...
  @override
  State<StrengthTrainingUSeventeenAndUNineteenScreen> createState() =>
      _StrengthTrainingUSeventeenAndUNineteenScreenState();
}

class _StrengthTrainingUSeventeenAndUNineteenScreenState
    extends State<StrengthTrainingUSeventeenAndUNineteenScreen> {
  ...
  void _navigateToDetailsScreen(StrengthTrainingGroup item) {
    Navigator.push(
      ...
      MaterialPageRoute(
        builder:
            (_) => StrengthTrainingUSeventeenAndUNineteenVideoListScreen(
              id: item.id,
              name: item.teamName ?? "",
