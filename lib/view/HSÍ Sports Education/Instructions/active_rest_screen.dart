...
// load active rest details from web server
// and display those within this screen
// from other class, data is passed to this screen via constructor call
class ActiveRestScreen extends StatefulWidget {
  final int id;
  ...
  @override
  State<ActiveRestScreen> createState() => _ActiveRestScreenState();
}

class _ActiveRestScreenState extends State<ActiveRestScreen> {
