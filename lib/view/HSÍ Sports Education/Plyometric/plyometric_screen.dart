...
class PlyometricScreen extends StatefulWidget {
  final int id;
  final String name;
  final String image;

  const PlyometricScreen({
    super.key,
    required this.id,
    required this.name,
    required this.image,
  ...
  @override
  State<PlyometricScreen> createState() => _PlyometricScreenState();
}

class _PlyometricScreenState extends State<PlyometricScreen> {
