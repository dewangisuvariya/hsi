...
// load U eighteen women tournament details from web server
// and display those within this screen
// from other class, data is passed to this screen via constructor call
class UEighteenWomenScreen extends StatefulWidget {
  final int teamId;
  final String teamName;
  final String teamImage;

  const UEighteenWomenScreen({
    Key? key,
  ...
  @override
  _UEighteenWomenScreenState createState() => _UEighteenWomenScreenState();
}

class _UEighteenWomenScreenState extends State<UEighteenWomenScreen> {
