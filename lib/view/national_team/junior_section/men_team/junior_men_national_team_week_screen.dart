...
// load junior men national team week details from web server
// and display those within this screen
// from other class, data is passed to this screen via constructor call
class JuniorTeamsScreen extends StatefulWidget {
  final int teamId;
  final String teamName;
  final String teamImage;

  const JuniorTeamsScreen({
    Key? key,
  ...
  @override
  _JuniorTeamsScreenState createState() => _JuniorTeamsScreenState();
}

class _JuniorTeamsScreenState extends State<JuniorTeamsScreen> {
