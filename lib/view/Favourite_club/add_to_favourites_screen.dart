...
// // load Favorites club  details from web server
// // and display those within this screen
// // from other class, data is passed to this screen via constructor call
// class AddToFavouritesScreen extends StatefulWidget {
//   final int? clubId; // Make these match what you're passing
//   final String? image;
...
//   // Load data using the _loadUserProfile and _loadClubPartners methods
//   Future<void> _loadData() async {
//     await _loadUserProfile();
//     await _loadClubPartners();
//   }

//   // Load data from the AddFavoriteClubHelper class via the web service.
...
//   // Load data from the ClubPratnerListHelper class via the web service.
...
//         itemCount: _clubPartners.length,
